...
this.element.append(b)}else{f='<embed name="'+this.internal.flash.id+'" id="'+this.internal.flash.id+'" src="'+this.internal.flash.swf+'"';f+=' width="0" height="0" bgcolor="'+this.options.backgroundColor+'"';f+=' quality="high" FlashVars="'+b+'"';f+=' allowScriptAccess="always"';f+=' type="application/x-shockwave-flash" pluginspage="https://web.archive.org/web/20190523141921/http://www.macromedia.com/go/getflashplayer" />';this.element.append(f)}this.internal.flash.jq=c("#"+this.internal.flash.id);this.internal.flash.jq.css({width:"0px",
...
/*
playback timings (ms):
  captures_list: 99.782
  exclusion.robots: 0.068
  exclusion.robots.policy: 0.059
  RedisCDXSource: 0.622
  esindex: 0.007
  LoadShardBlock: 76.111 (3)
  PetaboxLoader3.datanode: 108.693 (5)
  load_resource: 598.008 (2)
  PetaboxLoader3.resolve: 527.978 (2)
*/